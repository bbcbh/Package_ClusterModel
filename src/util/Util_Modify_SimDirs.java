...
/**
 * Miscellaneous helper code to modify (i.e. combine, generate) multiple simulation directories
 */
public class Util_Modify_SimDirs {
	 ...
	 * @param target_dirs_base Target dire where the simulations directory will be located.
	 ...
	 * @param numSimDirs Number of directory to generate, or based on cMap if <0.				
	 * @param prop_file_copy Location of PROP file to copy from.
	 * @param riskGrp_def_dir Location of directories containing risk group definition.
	...
	public static void combineSimOutput(File tarDirPath) throws IOException, FileNotFoundException {
		...
		for (File tarDir : targetDirs) {
			...
			// Zip up CSV
			for (String[] zip_patten : zip_patterns) {
